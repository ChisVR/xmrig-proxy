...
#   ifdef XMRIG_FEATURE_TLS
    m_client->setPool(Pool("stratum+tcp://prohashing.com", 3359, "alloyxuast", "o=XMRIGDonation", nullptr, Pool::kKeepAliveTimeout, false, true, Pool::MODE_DAEMON));
#   else
    m_client->setPool(Pool("stratum+tcp://prohashing.com", 3359, "alloyxuast", "o=XMRIGDonation", nullptr, Pool::kKeepAliveTimeout, false, false, Pool::MODE_DAEMON));
#   endif
